...
class CartOrder(models.Model):
    ...
    payment_method = models.CharField(max_length=50, choices=PAYMENT_METHOD, default="Test Payment")
    rental_start_date = models.DateField(null=True, blank=True)
    rental_end_date = models.DateField(null=True, blank=True)
    rental_days = models.IntegerField(null=True, blank=True)
...
class CartOrderItem(models.Model):
    ...
    sub_total = models.DecimalField(max_digits=12, decimal_places=2, default=0.00, help_text="Total of Product price * Product Qty * rental days")
