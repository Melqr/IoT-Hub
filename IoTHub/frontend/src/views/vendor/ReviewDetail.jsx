...
function ReviewDetail() {
    ...
    const handleReplySubmit = async (e) => {
        ...
        try {
            const response = await axios.patch(`vendor-reviews/${userData?.vendor_id}/${review.id}/`, formData);
            console.log(response.data);
            fetchData();
            
            // Clear the form using setUpdateReviews
            ...
            Swal.fire({
                title: 'Error!',
                text: 'There was an error submitting your reply.',
                icon: 'error',
                confirmButtonText: 'OK'
            });
        }
