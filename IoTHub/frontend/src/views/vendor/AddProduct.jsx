    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire({
                icon: 'Error',
                title: 'Missing Fields!',
                text: "All Sections need to fill to create a product",
            })
                                                ...
                                                <div className="card mb-3">
                                                    ...
                                                    {gallery.map((item, index) => (
                                                            <div className="row text-dark mb-5" key={index}>
                                                                ...
                                                                <img
                                                                    src={item.image ? item.image.preview : "https://developers.elementor.com/docs/assets/img/elementor-placeholder-image.png"}
                                                                    alt={`Preview for gallery item ${index + 1}`}
                                                                    style={{ width: '100%', height: '100px', objectFit: 'cover', borderRadius: 5 }}
                                                                />
                                                                </div>
                                                                <div className="col-lg-6 mb-2">
                                                                <label htmlFor={`product-image-${index}`} className="mb-2">
                                                                    Product Image
                                                                </label>
                                                                <input
                                                                    type="file"
