...
function Earning() {
  ...
  const months = earningChartData?.map(item => getMonthName(item.month));
                ...
                <div className="col-xl-6 col-lg-6 mb-2">
                  <div className="card card-inverse card-success">
                    <div className="card-block bg-success p-3">
                      ...
                      <h1 className="display-1"><b>RM {earningStats?.total_revenue || "0.00"}</b></h1>
                    </div>
                  </div>
                </div>
                <div className="col-xl-6 col-lg-6 mb-2">
                  <div className="card card-inverse card-danger">
                    <div className="card-block bg-danger p-3">
                      ...
                      <h1 className="display-1"><b>RM {earningStats?.monthly_revenue || "0.00"}</b></h1>
                    </div>
                  </div>
                </div>
              </div>
                    ...
                    <tbody>
                      {earningStatsTracker?.map((earning, index) => (
                        <tr>
                          ...
                          <td>RM{earning.total_earning.toFixed(2)}</td>
                          {/* <td>
                    ...
                    <div className="col-md-12 py-1">
                      <div className="card">
                        <div className="card-body">
                          <Line data={revenue_data} options={chartOptions} style={{ height: 300, minWidth: "630px" }} />
                        </div>
                      </div>
                    </div>
                  </div>
