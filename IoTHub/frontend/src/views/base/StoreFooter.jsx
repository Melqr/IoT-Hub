        ...
        <div className="container-fluid p-4">
          ...
          <div className="row">
            ...
            <div className="col-lg-4 mb-4 mb-lg-0">
              ...
              <p>
              IoT-Hub is a cutting-edge platform designed to simplify the rental and 
              management of Internet of Things (IoT) devices. It offers a user-friendly 
              experience with a multi-vendor strategy, allowing access to a diverse range of devices. 
                sint!
              </p>
            </div>
            {/*Grid column*/}
