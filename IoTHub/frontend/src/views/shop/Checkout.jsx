...
function Checkout() {
  ...
  // Function to handle the "Payment Test" button click
  const handlePaymentTest = () => {
    navigate(`/payment-success/${order.oid}/?test_payment=true`);
  };
                ...
                <div className="col-lg-4 mb-4 mb-md-0">
                  ...
                  <section className="shadow-4 p-4 rounded-5 mb-4">
                    ...
                    <div className="d-flex justify-content-between mb-3">
                      <span>Subtotal </span>
                      <span>RM{order.sub_total}</span>
                    </div>
                    <div className="d-flex justify-content-between">
                      <span>Shipping </span>
                      <span>RM{order.shipping_amount}</span>
                    </div>
                    <div className="d-flex justify-content-between">
                      <span>Tax </span>
                      <span>RM{order.tax_fee}</span>
                    </div>
                    <div className="d-flex justify-content-between">
                      <span>Servive Fee </span>
                      <span>RM{order.service_fee}</span>
                    </div>
                    <hr className="my-4" />
                  ...
                  {/*
                    <PayPalScriptProvider options={initialOptions}>
                      ...
                      {/* Add the Payment Test button 
                    <button onClick={handlePaymentTest} className="btn btn-secondary btn-rounded w-100 mt-2">
                      Payment Test
                    </button>
                        */}
