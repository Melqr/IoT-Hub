...
function Products() {
    ...
    //rental
    const handleRentalStartDateChange = (event, product_id) => {
        setRentalStartDate(event.target.value);
        setSelectedProduct(product_id);
    };

    const handleRentalEndDateChange = (event, product_id) => {
    ...
    const handleAddToCart = async (product_id, price, shipping_amount) => {
        ...
        const rental_days= Math.ceil((new Date(rentalEndDate) - new Date(rentalStartDate)) / (1000 * 60 * 60 * 24));
        try {
            ...
            {loading === false &&
                <div>
                                        ...
                                        <div className="col-lg-4 col-md-12 mb-4" key={index.id}>
                                            <div className="card">
                                                ...
                                                >
                                                    <Link to={`/detail/${product.slug}`}>
                                                        <img
                                                            ...
                                                            className="w-100"
                                                            style={{ width: "60px", height: "200px", objectFit: "contain", padding:"1rem"}}
                                                        />
                                                    </Link>
                                                </div>
                                                <div className="card-body">
                                                    ...
                                                    <Link to={`/detail/${product.slug}`} className="text-reset"><h6 className="card-title mb-3 ">{product.title.slice(0, 100)}...</h6></Link>
                                                    <Link to="/" className="text-reset"><p>{product?.brand.title}</p></Link>
                                                    <h6 className="mb-1">RM{product.price}/day</h6>
                                                                        ...
                                                                        <>
                                                                            <li>
                                                                                <input
                                                                                    ...
                                                                                    onChange={(e) => handleRentalStartDateChange(e, product.id)}
                                                                                    min={todayDate} // Restrict to not allow dates before today
                                                                                    value={selectedProduct === product.id ? rentalStartDate : ''}
                                                                                />
                                                                            </li>
                                                                        </>
                                                                    </div>
                                                                        ...
                                                                        <>
                                                                            <li>
                                                                                <input
                                                                                    ...
                                                                                    onChange={(e) => handleRentalEndDateChange(e, product.id)}
                                                                                    min={rentalStartDate || todayDate} // Ensure end date is after start date
                                                                                    value={selectedProduct === product.id ? rentalEndDate : ''}
                                                                                />
                                                                            </li>
                                                                        </>
                                                                    </div>
                    ...
                    <main>
                        ...
                        <div className="d-flex justify-content-center">
                        {category.map((c, index) => (
                            <div key={c.id} className="align-items-center d-flex flex-column" style={{ background: "#e8e8e8", marginLeft: "10px", borderRadius: "10px", padding: "30px" }}>
                                <img src={c.image}
                                    alt=""
                                    style={{ width: "80px", height: "80px", objectFit: "cover" }}
                                />
