...
function ProductDetail() {
    ...
    // Function to handle changes in rental start date
    ...
    const handleRentalStartDateChange = (event) => {
        setRentalStartDate(event.target.value);
    };

    // Function to handle changes in rental end date
    const handleRentalEndDateChange = (event) => {
    ...
    const handleAddToCart = async () => {
        ...
        try {
            ...
            await addToCart(product.id, userData?.user_id, qtyValue, product.price, product.shipping_amount, currentAddress.country, colorValue, cart_id,rentalStartDate,
                rentalEndDate,rental_days, setIsAddingToCart);
            ...
            // Reset rental dates after adding to cart
    ...
    const handleAddToWishlist = () => {
        if (!userData || !userData.user_id) {
            Swal.fire({
                icon: 'warning',
                title: 'User needs to login first',
                text: 'Please login or register to add items to your wishlist.',
            });
            return;
        }
        if (userData) {
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <div className="row flex-column">
                                                ...
                                                <div className="col-md-6 mb-4">
                                                    <div className="form-outline">
                                                        <label className="form-label" htmlFor="rentalStartDate"><b>Rental Start Date</b></label>
                                                        <input
                                                            type="date"
                                                            id="rentalStartDate"
                                                ...
                                                <div className="col-md-6 mb-4">
                                                    <div className="form-outline">
                                                        <label className="form-label" htmlFor="rentalEndDate"><b>Rental End Date</b></label>
                                                        <input
                                                            type="date"
                                                            id="rentalEndDate"
                                                            className="form-control"
